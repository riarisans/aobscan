...
private:
	static std::vector<DWORD> scan(const HANDLE& handle, const char* pattern, const char* mask);
	static std::vector<DWORD> scan(const HANDLE& handle, const char* pattern);
